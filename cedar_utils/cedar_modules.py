...
class Convolution(object):
    ''' Class around a nengo.Node that receives two inputs and performs
        a convolution on one of the inputs with the other one as the 
        kernel.
        ...
        Notes
        -----
        The two inputs are of the same size: The first input is the kernel
        for the convolution, the second input is the matrix to convolve 
        with. Since they always have the same size in the spatial 
        reasoning architecture I only implemented this case here for 
        simplicity. 
    '''
